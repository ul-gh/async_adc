...
from .ads1256_definitions import Flags, Inputs
...
class ADS1256Config:
    ...
    DATA_TIMEOUT = 1e-6 + 50.0 / CLKIN_FREQUENCY
    # Command-to-command timeout after SYNC and RDATAC
    # commands (datasheet: t11)
    SYNC_TIMEOUT = 1e-6 + 24.0 / CLKIN_FREQUENCY
    ...
    CS_TIMEOUT = 1e-6 + 8.0 / CLKIN_FREQUENCY
    ...
    T_11_TIMEOUT = 1e-6 + 4.0 / CLKIN_FREQUENCY
    ############################################################################
